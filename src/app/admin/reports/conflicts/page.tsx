...
export const metadata = {
  title: "Conflicts Report | Reports",
  description: "Identify scheduling conflicts and staffing gaps",
};
...
export default async function ConflictsReportPage() {
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Identify scheduling conflicts, understaffing, and coverage gaps
          </p>
        </div>
