...
export const metadata = {
  ...
  description: "Staff availability reports and analytics for your team",
};
  ...
  const quickActions = [
    {
      ...
      icon: Calendar,
      href: "/manage/reports/availability-matrix",
      color: "text-blue-600",
    },
    {
  ...
  return (
    <DashboardLayout user={user}>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold">Team Reports & Analytics</h1>
          <p className="text-muted-foreground mt-1">
            View your team's availability, analyze coverage, and generate reports
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Additional reporting features available for your team
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Link href="/manage/reports/ai-chat">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                AI-powered scheduling recommendations for your team
              </p>
              <Link href="/manage/reports/suggestions">
