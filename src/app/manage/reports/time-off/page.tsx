...
export const metadata = {
  title: "Time-Off Report | Team Reports",
  description: "View and analyze your team's time-off requests and coverage impact",
};
...
export default async function ManagerTimeOffReportPage() {
  ...
  if (user.role.name === "ADMIN") {
    redirect("/system/reports/time-off");
  }
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            View and analyze your team's time-off requests and their impact on coverage
          </p>
        </div>
