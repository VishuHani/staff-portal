...
import { updateEmail, deleteEmail, duplicateEmail, saveEmailAsTemplate } from "@/lib/actions/emails";
...
export function EditEmailClient({ 
  ...
  const [venueId, setVenueId] = useState<string>(initialEmail.venueId || (isAdmin ? "" : (userVenueId || "")));
