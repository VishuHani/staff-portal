...
export const metadata = {
  ...
  description: "System-wide staff availability reports and analytics",
};
...
export default async function ReportsPage() {
  ...
  if (!hasAccess) {
    // Managers should use /reports instead
    const hasTeamAccess = await canAccess("reports", "view_team");
    if (hasTeamAccess) {
  ...
  const quickActions = [
    {
      ...
      icon: Calendar,
      href: "/system/reports/availability-matrix",
      color: "text-blue-600",
    },
    {
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            System-wide reports across all venues and staff
          </p>
        </div>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Link href="/system/reports/ai-chat">
            ...
            <div className="space-y-2">
              ...
              <Link href="/system/reports/predictive">
